	...
	<section class="w-100 mt-9 mb-9 flex justify-content-center">
		<div class="col-xl-10 col-lg-10 col-md-10 col-sm-10 col-xs-12 mt-2 mb-2">
			<div class="w-100 mt-5 mb-5 start">
				<h2 class="title text-blue_1">Publicaciones</h2>
			</div>
			<div class="w-100 mt-5 mb-5 start">
				<div class="w-100 mt-2 mb-2 flex">
					<div class="col-xl-1 col-lg-1 col-md-2 col-sm-2 col-xs-2 flex-link">
						<span class="icon-file-pdf icon-file"></span>
					</div>
					<div class="col-xl-11 col-lg-11 col-md-10 col-sm-10 col-xs-10 flex-link">
						<a class="title-mb text-blue-link" target="_blank" href="./download/pdf/GUIA DEL SISTEMA ESTATAL ANTICORRUPCION - V2.pdf">
							GUÍA DEL SISTEMA ESTATAL ANTICORRUPCIÓN
						</a>
					</div>
				</div>
				<div class="w-100 mt-2 mb-2 flex">
					...
					<div class="col-xl-11 col-lg-11 col-md-10 col-sm-10 col-xs-10 flex-link">
						<a class="title-mb text-blue-link" target="_blank" href="./download/pdf/GUIA DE DELITOS Y FALTAS ADMINISTRATIVAS - V2.pdf">
							GUÍA DE DELITOS Y FALTAS ADMINISTRATIVAS
						</a>
					</div>
				</div>
			</div>
